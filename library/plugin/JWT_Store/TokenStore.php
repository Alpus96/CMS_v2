<?php
    ...
    * */
    ...
    require_once ROOT_PATH.'library/plugin/JWT_Store/lib/TokenStorage.php';
    require_once ROOT_PATH.'library/plugin/JWT_Store/lib/jwt/JWT.php';
    ...
    class TokenStore extends TokenStorage {
        ...
        * */
        function create ($id, $payload) {
            ...
            if (!is_string($id) && !is_numeric($id) || !is_array($payload) && !is_object($payload)) { return false; }
