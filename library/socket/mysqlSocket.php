<?php
define('ROOT_PATH', '/users/alpus96/sites/projects/cms_v2/');
    /**
    ...
    * */
    ...
    require_once ROOT_PATH.'library/debug/Logger.php';      //  Require the logger class file for error logging.
    ...
    class MysqlSocket {
        ...
        * */
        protected function __construct() {
            ...
            if (!$config) { self::logError(0, 'Could not read mysqlSocket configuration file.'); return; }
