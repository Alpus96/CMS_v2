<?php
    ...
    * */
    ...
    //  Require files outside jwt_store
    require_once dirname(__DIR__).'/socket/json.php';
    require_once dirname(__DIR__).'/socket/logs.php';

    //  Require jwt_store lib files.
    require_once 'lib/jwt_db.php';
    require_once 'lib/jwt_gen/JWT.php';

    class TokenStore extends TokenDB {

        static private $config;
        static private $jwt_gen;
